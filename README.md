...
A word guessing game where you compete against an AI bot that learns from each game using reinforcement learning techniques. Check out project [Report](https://drive.google.com/file/d/1nWOMuOkrT-CSw2qIrYGNqFrWf-YF5kYi/view?usp=sharing).
...
```bash
git clone https://github.com/diophantinepi/AI-vs-Humans-Word-Guessing-Game
cd AI-vs-Humans-Word-Guessing-Game
```
